        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" href="#payroll_tab" data-toggle="tab" aria-expanded="true">
                    ...
                    @if($is_admin)
                        <li class="nav-item">
                            <a class="nav-link " href="#payroll_group_tab" data-toggle="tab" aria-expanded="true">
                    ...
                    @if(auth()->user()->can('essentials.view_allowance_and_deduction') || auth()->user()->can('essentials.add_allowance_and_deduction'))
                        <li class="nav-item">
                            <a class="nav-link " href="#pay_component_tab" data-toggle="tab" aria-expanded="true">
