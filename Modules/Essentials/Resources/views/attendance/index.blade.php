        ...
        <div class="row">
            ...
            &nbsp;&nbsp;&nbsp;
                <button 
                    ...
                    data-type="clock_out"
                    >
                    <i class="fa fa-hourglass-half fa-spin"></i> @lang('essentials::lang.clock_out')
                </button>
                @if(!empty($clock_in))
                    <br>
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    @can('essentials.crud_all_attendance')
                        <li class="nav-item">
                            <a class="nav-link active" href="#shifts_tab" data-toggle="tab" aria-expanded="true">
                    ...
                    @endcan
                    <li class="nav-item" @if(!auth()->user()->can('essentials.crud_all_attendance')) class="active" @endif>
                        <a class="nav-link " href="#attendance_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-check-square" aria-hidden="true"></i> @lang( 'essentials::lang.all_attendance' )</a>
                    </li>
                    @can('essentials.crud_all_attendance')
                    <li class="nav-item">
                        <a class="nav-link " href="#attendance_by_shift_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-user-check" aria-hidden="true"></i> @lang('essentials::lang.attendance_by_shift')</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="#attendance_by_date_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-calendar" aria-hidden="true"></i> @lang('essentials::lang.attendance_by_date')</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="#import_attendance_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-download" aria-hidden="true"></i> @lang('essentials::lang.import_attendance')</a>
                    </li>
                    @endcan
                </ul>
