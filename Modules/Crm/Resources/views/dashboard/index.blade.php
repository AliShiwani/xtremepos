	...
	<div class="row row-custom">
		@if( $contact->type == 'supplier' || $contact->type == 'both')
	    	<div class="col-md-3 col-sm-6 col-xs-12 col-custom">
		      <div class="info-card info-card-new-style">
		        <span class="info-card-icon bg-aqua"><i class="ion ion-cash"></i></span>
		        <div class="info-card-content">
		          <span class="info-card-text fs-10">@lang('report.total_purchase')</span>
		          <span class="info-card-number display_currency" data-currency_symbol="true">
