		...
		<div class="card-body">
	    	...
	    	<div class="row">
				...
				<div class="col-sm-6">
					<div class="checkbox">
					<label>
						{!! Form::checkbox('is_private', 1, $packages->is_private, ['class' => 'form-check-input']); !!}
				...
				<div class="col-sm-6">
					<div class="checkbox">
					<label>
						{!! Form::checkbox('is_one_time', 1, $packages->is_one_time, ['class' => 'form-check-input']); !!}
				...
				<div class="col-sm-4">
					<div class="checkbox">
					<label>
						{!! Form::checkbox('enable_custom_link', 1, $packages->enable_custom_link, ['class' => 'form-check-input', 'id' => 'enable_custom_link']); !!}
				...
				@foreach($permissions as $module => $module_permissions)
					...
					<div class="col-sm-3">
						<div class="checkbox">
						<label>
							{!! Form::checkbox("custom_permissions[$permission[name]]", 1, $value, ['class' => 'form-check-input']); !!}
	                        {{$permission['label']}}
						</label>
						</div>
					</div>
				...
				<div class="col-sm-3 ">
					...
					<div class="checkbox">
					<label>
                        {!! Form::checkbox('is_active', 1, $packages->is_active, ['class' => 'form-check-input']); !!}
				...
				<div class="col-sm-4">
					<div class="checkbox">
					<label>
                        {!! Form::checkbox('update_subscriptions', 1, false, ['class' => 'form-check-input']); !!}
