    ...
    <div class="row">
    	<div class="col-xs-4">
            <div class="form-group">
                ...
                <!-- <div class="input-group">
                    <span class="input-group-addon"   style="margin-top: 6px; margin-right: 7px;">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <!-- <div class="input-group">
                    <span class="input-group-addon" style="margin-top: 6px; margin-right: 7px; margin-left:3px" >
        ...
        <div class="col-sm-4">
            ...
            <div class="input-group mb-2">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="basic-addon1"> <i class="fa fa-exclamation-triangle"></i></span>
                </div>
                {!! Form::number('package_expiry_alert_days', $settings["package_expiry_alert_days"], ['class' => 'form-control','placeholder' => __('superadmin::lang.package_expiry_alert_days'), 'required']); !!}
            </div>
            </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <label>
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'superadmin::lang.enable_business_based_username' ) }}
                </label>
