<div class="pos-tab-content">
    <div class="row">
        ...
        <div class="col-md-4 @if(in_array('quantity', $default_settings['product_fields_for_create'])) hide @endif create_stock_settings">
            <div class="form-group">
        ...
        <div class="clearfix"></div>
        <div class="col-md-4 @if(in_array('quantity', $default_settings['product_fields_for_update'])) hide @endif update_stock_settings">
            <div class="form-group">
