...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="class="alert alert-danger alert-dismissible" role="alert">
            ...
            <div class="col-sm-12">
               <div class="card card-solid">
                    <div class="card-header">
                        ...
                        <h3 class="card-title">@lang('woocommerce::lang.sync_product_categories'):</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12">
               <div class="card card-solid">
                    <div class="card-header">
                        ...
                        <h3 class="card-title">@lang('woocommerce::lang.map_tax_rates'):</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12">
                <div class="card card-solid">
                    <div class="card-header">
                        ...
                        <h3 class="card-title">@lang('woocommerce::lang.sync_products'):</h3>
                    </div>
                    <div class="card-body">
           ...
           <div class="col-sm-12">
               <div class="card card-solid">
                    <div class="card-header">
                        ...
                        <h3 class="card-title">@lang('woocommerce::lang.sync_orders'):</h3>
                    </div>
                    <div class="card-body">
                        <div class="col-sm-6">
