        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                 <ul class="nav nav-tabs">
                    <li class="nav-item ">
                        <a class="nav-link active" href="#pending_job_sheet_tab" data-toggle="tab" aria-expanded="true">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#completed_job_sheet_tab" data-toggle="tab" aria-expanded="true">
