        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" href="#repair_status_tab" data-toggle="tab" aria-expanded="true">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#repair_device_tab" data-toggle="tab" aria-expanded="true">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#repair_device_models_tab" data-toggle="tab" aria-expanded="true">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#repair_settings_tab" data-toggle="tab" aria-expanded="true">
