	...
	<div class="col-sm-3">
		<div class="form-group">
			<!-- <div class="input-group">
				<span class="input-group-addon"  style="margin-top: 7px; margin-right: 5px;">
		...
		<div class="col-md-12 col-sm-12">
			@component('components.widget', ['class' => 'box-solid'])
				...
				@if(in_array('subscription', $enabled_modules))
					<div class="col-md-12 pull-right col-sm-6">
						<div class="checkbox">
							<label>
		        ...
		        <div class="col-sm-4">
					...
					<div class="custom-file">
                        ...
                        <input type="file" name="" class="custom-file-input" accept ="implode(',', array_keys(config('constants.document_upload_mimes_types')))" id="customFile">
					...
					<div class="form-group">
						<div class="input-group">
							<div class="input-group-btn">
								<button type="button" class="btn btn-default bg-white btn-flat" data-toggle="modal" data-target="#configure_search_modal" title="{{__('lang_v1.configure_product_search')}}"><i class="fa fa-search-plus"></i></button>
							</div>
...
value="@if(empty($edit)) {{@num_format($business_details->tax_calculation_amount)}} @else {{@num_format(optional($transaction->tax)->amount)}} @endif" data-default="{{$business_details->tax_calculation_amount}}">
	        ...
	        <div class="col-md-4">
				...
				<div class="custom-file">
				{!! Form::file('shipping_documents[]', ['class' => 'custom-file-input', 'multiple', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
			...
			<div class="col-md-12 col-md-offset-4" id="additional_expenses_div" style="display: none;">
	...
	@if(!empty($common_settings['is_enabled_export']) && $sale_type != 'sales_order')
		@component('components.widget', ['class' => 'box-solid', 'title' => __('lang_v1.export')])
	        ...
	        @endphp
	        @for($i; $i <= 6 ; $i++)
	            <div class="col-md-12 export_div" @if(empty($walk_in_customer['is_export'])) style="display: none;" @endif>
	                <div class="form-group">
