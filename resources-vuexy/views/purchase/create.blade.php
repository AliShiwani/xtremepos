		...
		<div class="row">
			<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<button type="button" class="btn btn-default bg-white btn-flat add_new_supplier" data-name="">
			...
			<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
				<div class="form-group">
					...
					<!-- <div class="input-group">
						<span class="input-group-addon" style="margin-top: 14px;margin-right: 2px;">
			...
			<div class="col-sm-3">
				...
				{!! Form::label('document', __('purchase.attach_document') . ':') !!}
					...
					<div class="custom-file">
                        <input type="file" class="custom-file-input" accept = "implode(',', array_keys(config('constants.document_upload_mimes_types')))">
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="table-responsive">
					<table class="table table-condensed table-bordered table-th text-center table-striped" id="purchase_entry_table">
						<thead>
							<tr>
								<th>#</th>
	...
	<div class="row">
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<button type="button" class="btn btn-primary btn-sm" id="toggle_additional_expense"> <i class="fa fa-plus"></i> @lang('lang_v1.add_additional_expenses') <i class="fa fa-chevron-down"></i></button>
			</div>
