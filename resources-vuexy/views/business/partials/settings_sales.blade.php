<div class="pos-tab-content">
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <!-- <div class="input-group" style="display:flex">
                   <div>
                   <span class="input-group-addon" style="margin-right:7px">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::checkbox('pos_settings[enable_msp]', 1,  
                    ...
                    [ 'class' => 'form-check-input','id'=>'sale_price_is_minimum_sale_price']); !!}
                  <label class="form-check-label" for="sale_price_is_minimum_sale_price" >
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                {!! Form::checkbox('pos_settings[enable_sales_order]', 1, !empty($pos_settings['enable_sales_order']) , [ 'class' => 'form-check-input', 'id' => 'enable_sales_order']); !!}
                    <label class="form-check-label" for="enable_sales_order" >
