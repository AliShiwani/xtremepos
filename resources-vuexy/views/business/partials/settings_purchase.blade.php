...
<div class="pos-tab-content">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            <div class="checkbox">
                ...
                [ 'class' => 'form-check-input', 'id' => 'purchase_in_diff_currency']); !!} {{ __( 'purchase.allow_purchase_different_currency' ) }}
                </label>
        ...
        <div class="form-group">
            <div class="checkbox">
              <label class="form-check-label">
                ...
                [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.enable_editing_product_from_purchase' ) }}
              </label>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <div class="checkbox">
                <label class="form-check-label">
                {!! Form::checkbox('enable_purchase_status', 1, $business->enable_purchase_status , [ 'class' => 'form-check-input', 'id' => 'enable_purchase_status']); !!} {{ __( 'lang_v1.enable_purchase_status' ) }}
                </label>
...
<div class="clearfix"></div>
    <div class="col-sm-6">
        <div class="form-group">
            <div class="checkbox">
                <label class="form-check-label">
                {!! Form::checkbox('enable_lot_number', 1, $business->enable_lot_number , [ 'class' => 'form-check-input', 'id' => 'enable_lot_number']); !!} {{ __( 'lang_v1.enable_lot_number' ) }}
                </label>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <div class="checkbox">
                <label class="form-check-label">
                {!! Form::checkbox('common_settings[enable_purchase_order]', 1, !empty($common_settings['enable_purchase_order']) , [ 'class' => 'form-check-input', 'id' => 'enable_purchase_order']); !!} {{ __( 'lang_v1.enable_purchase_order' ) }}
                </label>
