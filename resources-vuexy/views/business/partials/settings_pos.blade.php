            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.disable_pay_checkout' ) }}
                  </label>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.disable_draft' ) }}
                  </label>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.disable_express_checkout' ) }}
                  </label>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.hide_product_suggestion' ) }}
                  </label>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.hide_recent_trans' ) }}
                  </label>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.disable_discount' ) }}
                  </label>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.disable_order_tax' ) }}
                  </label>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.subtotal_editable' ) }}
                  </label>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.disable_suspend_sale' ) }}
                  </label>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.enable_pos_transaction_date' ) }}
                  </label>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.enable_service_staff_in_product_line' ) }}
                  </label>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.is_service_staff_required' ) }}
                  </label>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.disable_credit_sale_button' ) }}
                  </label>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.enable_weighing_scale' ) }}
                  </label>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.show_invoice_scheme' ) }}
                  </label>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.show_invoice_layout' ) }}
                  </label>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.print_on_suspend' ) }}
                  </label>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <br>
                  <label class="form-check-label">
                    ...
                    [ 'class' => 'form-check-input']); !!} {{ __( 'lang_v1.show_pricing_on_product_sugesstion' ) }}
                  </label>
                </div>
            </div>
        </div>
