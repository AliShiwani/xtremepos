    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::checkbox('enable_brand', 1, $business->enable_brand, 
                    [ 'class' => 'custom-control-input','id'=>'enable_brand']); !!}
                  <label class="custom-control-label" for="enable_brand">{{ __( 'lang_v1.enable_brand' ) }}</label>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <!-- <div class="custom-control custom-checkbox">
                {!! Form::checkbox('enable_category', 1, $business->enable_category, [ 'class' => 'custom-control-input', 'id' => 'enable_category']); !!}                  
                <label class="custom-control-label" for="enable_category">{{ __( 'lang_v1.enable_category' ) }}     </label>
                </div> -->
                <div class="custom-control custom-checkbox">
                {!! Form::checkbox('enable_category', 1, $business->enable_category, [ 'class' => 'custom-control-input', 'id' => 'enable_category']); !!}
                <label class="custom-control-label" for="enable_category">{{ __( 'lang_v1.enable_category' ) }}   </label>
        ...
        <div class="col-sm-4 enable_sub_category @if($business->enable_category != 1) hide @endif">
            <div class="form-group">
                ...
                <div class="custom-control custom-checkbox">
                {!! Form::checkbox('enable_sub_category', 1, $business->enable_sub_category, [ 'class' => 'custom-control-input', 'id' => 'enable_sub_category']); !!} 
                <label class="custom-control-label" for="enable_sub_category">{{ __( 'lang_v1.enable_sub_category' ) }}    </label>
                </div>
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="custom-control custom-checkbox">
                {!! Form::checkbox('enable_price_tax', 1, $business->enable_price_tax, [ 'class' => 'custom-control-input','id'=>'enable_price_tax']); !!} 
                <label class="custom-control-label" for="enable_price_tax">{{ __( 'lang_v1.enable_price_tax' ) }}    </label>
                </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="custom-control custom-checkbox">
                {!! Form::checkbox('enable_sub_units', 1, $business->enable_sub_units, [ 'class' => 'custom-control-input','id'=>'enable_sub_units']); !!} 
                <label class="custom-control-label" for="enable_sub_units">{{ __( 'lang_v1.enable_sub_units' ) }}  </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="custom-control custom-checkbox">
                {!! Form::checkbox('enable_racks', 1, $business->enable_racks, [ 'class' => 'custom-control-input','id'=>'enable_racks']); !!} 
                <label class="custom-control-label" for="enable_racks">{{ __( 'lang_v1.enable_racks' ) }} </label>
                @show_tooltip(__('lang_v1.tooltip_enable_racks'))
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="custom-control custom-checkbox">
                {!! Form::checkbox('enable_row', 1, $business->enable_row, [ 'class' => 'custom-control-input','id'=>'enable_row']); !!} 
                <label class="custom-control-label" for="enable_row">{{ __( 'lang_v1.enable_row' ) }} </label>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="custom-control custom-checkbox">
                {!! Form::checkbox('enable_position', 1, $business->enable_position, [ 'class' => 'custom-control-input','id'=>'enable_position']); !!} 
                <label class="custom-control-label" for="enable_position">{{ __( 'lang_v1.enable_position' ) }} </label>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="custom-control custom-checkbox">
                {!! Form::checkbox('common_settings[enable_product_warranty]', 1, !empty($common_settings['enable_product_warranty']) ? true : false, 
                    [ 'class' => 'custom-control-input','id'=>'enable_product_warranty']); !!} 
                <label class="custom-control-label" for="enable_product_warranty">{{ __( 'lang_v1.enable_product_warranty' ) }} </label>
