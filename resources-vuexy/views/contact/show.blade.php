                            ...
                            @if($reward_enabled)
                                <div class="col-md-3">
                                    <div class="info-card bg-yellow">
                                        <span class="info-card-icon"><i class="fa fa-gift"></i></span>

                                        <div class="info-card-content">
                                          <span class="info-card-text">{{session('business.rp_name')}}</span>
                                          <span class="info-card-number">{{$contact->total_rp ?? 0}}</span>
                                        </div>
                                        <!-- /.info-card-content -->
                                    </div>
                                </div>
