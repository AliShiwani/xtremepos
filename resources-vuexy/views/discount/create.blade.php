<div class="modal-dialog" style="margin-top:57px" role="document">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group custom-control custom-checkbox">
            ...
            {!! Form::checkbox('applicable_in_cg', 1, false, ['class' => 'custom-control-input','id'=>'langv1applicableincg']); !!}
            <label class="custom-control-label" for="langv1applicableincg">
        ...
        <div class="col-sm-6">
          <div class="form-group custom-control custom-checkbox">
          {!! Form::checkbox('is_active', 1, true, ['class' => 'custom-control-input','id'=>'langv1isactive']); !!}
            <label class="custom-control-label" for="langv1isactive">
