...
<section class="content">
    ...
    <div class="card card-solid">
        <div class="card-header print_section">
            <h3 class="card-title">{{session()->get('business.name')}} - @lang( 'account.balance_sheet') - <span id="hidden_date">{{@format_date('now')}}</span></h3>
        </div>
        <div class="card-body">
