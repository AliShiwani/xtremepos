    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-4">
          ...
          <br>
            <label>
              {!! Form::checkbox('enable_stock', 1, true, ['class' => 'form-check-input', 'id' => 'enable_stock']); !!} 
              <strong>@lang('product.manage_stock')</strong>
            </label class="form-check-label">@show_tooltip(__('tooltip.enable_stock')) <p class="help-block"><i>@lang('product.enable_stock_help')</i></p>
          </div>
        </div>
        <div class="clearfix"></div>
