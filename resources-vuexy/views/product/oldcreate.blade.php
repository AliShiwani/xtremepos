      ...
      <div class="clearfix"></div>
          ...
          <div class="form-group">
            ...
            <div class="input-group form-password-toggle mb-2">
               ...
               <div class="input-group-append">
                ...
                <button type="button" @if(!auth()->user()->can('unit.create')) disabled @endif class="btn btn-default bg-white btn-flat btn-modal" data-href="{{action('UnitController@create', ['quick_add' => true])}}" title="@lang('unit.add_unit')" data-container=".view_modal" style="border: 1px solid #aaa; border-radius: 0;">
        ...
        <div class="col-sm-4 @if(!session('business.enable_brand')) hide @endif">
          <div class="form-group">
            ...
            <span class="input-group-btn">
                <button type="button" @if(!auth()->user()->can('brand.create')) disabled @endif class="btn btn-default bg-white btn-flat btn-modal" data-href="{{action('BrandController@create', ['quick_add' => true])}}" title="@lang('brand.add_brand')" data-container=".view_modal" style="border: 1px solid #aaa;
border-radius: 0;
"><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
        ...
        <div class="col-sm-4">
          ...
          <br>
            <label>
              {!! Form::checkbox('enable_stock', 1, !empty($duplicate_product) ? $duplicate_product->enable_stock : true, ['class' => 'class="form-check-input"', 'id' => 'enable_stock']); !!} <strong>@lang('product.manage_stock')</strong>
          ...
          <div class="form-group">
            {!! Form::label('product_description', __('lang_v1.product_description') . ':') !!}
              {!! Form::textarea('
                ...
                product_description', !empty($duplicate_product->product_description) ? $duplicate_product->product_description : null, ['class' => 'form-control']); !!}
          </div>
        </div>
        <div class="col-sm-4">
          <!-- <div class="form-group">
    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-sm-4" style="margin-left:20px">
          <div class="form-group">
            ...
            <label class="form-check-label">
              {!! Form::checkbox('enable_sr_no', 1, !(empty($duplicate_product)) ? $duplicate_product->enable_sr_no : false, ['class' => 'form-check-input']); !!} <strong>@lang('lang_v1.enable_imei_or_sr_no')</strong>
        ...
        <div class="col-sm-4" style="margin-left:20px">
          <div class="form-group">
            <br>
            <label class="form-check-label">
              {!! Form::checkbox('not_for_selling', 1, !(empty($duplicate_product)) ? $duplicate_product->not_for_selling : false, ['class' => 'form-check-input']); !!} <strong>@lang('lang_v1.not_for_selling')</strong>
