...
<section class="content-header">
    <h1  style="padding-left: 11px;padding-bottom: 7px;">@lang('sale.products')
    ...
    <div class="row">
        ...
        <div class="col-md-3" id="location_filter">
            <div class="form-group">
                ...
                <label for="basicInput">Business Location</label>
        ...
        <div class="col-md-3">
          <div class="form-group">
            <br>
            <label>
              {!! Form::checkbox('not_for_selling', 1, false, ['class' => 'form-check-input', 'id' => 'not_for_selling']); !!} <strong>@lang('lang_v1.not_for_selling')</strong>
            </label>
          </div>
        </div>
        @if($is_woocommerce)
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::checkbox('woocommerce_enabled', 1, false, 
                      [ 'class' => 'custom-control-input', 'id' => 'woocommerce_enabled']); !!} 
                    <label class="custom-control-label" for="woocommerce_enabled">
           ...
           <!-- Custom Tabs -->
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active"  href="#product_list_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-cubes" aria-hidden="true"></i> @lang('lang_v1.all_products')</a>
                    </li>
                    @can('stock_report.view')
                    <li class="nav-item">
                        <a class="nav-link" href="#product_stock_report" data-toggle="tab" aria-expanded="true"><i class="fa fa-hourglass-half" aria-hidden="true"></i> @lang('report.stock_report')</a>
                    </li>
                    @endcan
                </ul>
...
<script type="9f077771e4a416638e9aebb7-text/javascript">
...
</script>                        <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="9f077771e4a416638e9aebb7-|49" defer=""></script></body>
