...
<div class="payment_details_div row @if( $payment_line['method'] !== 'card' ) {{ 'hide' }} @endif" data-type="card" >
...
<div class="payment_details_div row @if( $payment_line['method'] !== 'cheque' ) {{ 'hide' }} @endif" data-type="cheque" >
...
<div class="payment_details_div row @if( $payment_line['method'] !== 'bank_transfer' ) {{ 'hide' }} @endif" data-type="bank_transfer" >
